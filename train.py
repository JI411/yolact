...
parser.add_argument('--batch_alloc', default=None, type=str,
                    help='If using multiple GPUS, you can set this to be a comma separated list detailing' \
                         'which GPUs should get what local batch size (It should add up to your total batch size).')
parser.add_argument('--no_autoscale', dest='autoscale', action='store_false',
                    help='YOLACT will automatically scale the lr and the number of iterations depending'
...
def train():
    ...
    num_epochs = math.ceil(cfg.max_iter / epoch_size) if args.num_epoch is None else args.num_epoch
...
def compute_validation_loss(net, data_loader, criterion):
    ...
    with torch.no_grad():
        ...
        for datum in data_loader:
            ...
            wrapper = ScatterWrapper(targets, masks, num_crowds)   # what is ScatterWrapper? not imported
